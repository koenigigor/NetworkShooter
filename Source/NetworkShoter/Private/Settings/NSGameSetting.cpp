...
FSettingOption FSettingOption::GetErrorOption()
{
	return { LOCTEXT("ErrorOption", "ErrorOption"), -1 };
}
#undef LOCTEXT_NAMESPACE

UNSGameSetting* UNSGameSetting::NewSetting(FText InName, TArray<FSettingOption> InOptions, TFunction<int32()> InGetter, TFunction<void(int32)> InSetter, TSubclassOf<UNSSettingUIInfo> InUIInfo)
{
...
FSettingOption UNSGameSetting::GetCurrentOption()
{
	...
	if (Options.Num() == 0){ return FSettingOption::GetErrorOption(); }
