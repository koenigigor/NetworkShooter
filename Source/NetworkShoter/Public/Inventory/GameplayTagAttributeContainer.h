...
DECLARE_MULTICAST_DELEGATE_OneParam(FItemAttributeChange, const FGameplayTagAttribute& Attibute);
//DECLARE_MULTICAST_DELEGATE_ThreeParams(FItemAttributeChange, FGameplayTag Attibute, float NewValue, float OldValue);
